  ...
  return (
    <div className="animate-fade-in pb-4">
          ...
          <div className="mx-4 bg-card rounded-xl border border-border overflow-hidden">
            {section.items.map((item, i) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-muted transition-colors text-left ${i > 0 ? "border-t border-border" : ""}`}
              >
      ...
      <div className="px-4 mt-4">
        <button className="w-full flex items-center justify-center gap-2 py-3 bg-destructive/10 text-destructive rounded-xl font-semibold text-sm">
