...
export const BOOST_TIERS: BoostTier[] = [
  { id: 1, name: "Starter Boost", price: 50, currency: "KES", viewsPerDay: 200, color: "hsl(24 95% 53%)", benefits: ["200 views/day", "Priority in category", "Boost badge", "7-day duration", "Basic analytics", "Category highlight", "Search priority +1", "Featured in new", "Daily refresh", "Email report"] },
  { id: 2, name: "Growth Boost", price: 100, currency: "KES", viewsPerDay: 400, color: "hsl(45 93% 47%)", benefits: ["400 views/day", "Top of category", "Gold boost badge", "14-day duration", "Advanced analytics", "Homepage feature", "Search priority +3", "Push notifications", "Social sharing boost", "Weekly report"] },
  { id: 3, name: "Pro Boost", price: 200, currency: "KES", viewsPerDay: 600, color: "hsl(142 71% 45%)", benefits: ["600 views/day", "Featured banner", "Pro badge", "30-day duration", "Full analytics", "All categories feature", "Search priority +5", "Auto-renew option", "Priority support", "Monthly report"] },
  { id: 4, name: "Premium Boost", price: 350, currency: "KES", viewsPerDay: 800, color: "hsl(200 80% 50%)", benefits: ["800 views/day", "Premium placement", "Diamond badge", "45-day duration", "Real-time analytics", "Cross-category feature", "Search priority +8", "Dedicated account mgr", "Custom scheduling", "ROI tracking"] },
  { id: 5, name: "Enterprise Boost", price: 500, currency: "KES", viewsPerDay: 1000, color: "hsl(280 80% 55%)", benefits: ["1000 views/day", "Exclusive top spot", "Crown badge", "60-day duration", "AI-powered analytics", "Platform-wide feature", "Search priority +10", "24/7 priority support", "Multi-product boost", "Revenue dashboard"] },
];

export const VERIFICATION_TIERS: VerificationTier[] = [
  { id: 1, name: "Basic Verified", price: 0, currency: "KES", trialDays: 30, color: "hsl(200 80% 50%)", badgeIcon: "ShieldCheck", benefits: ["Blue checkmark", "Verified badge on profile", "Trust score boost +10", "Priority in search", "Verified label on products", "Basic fraud protection", "Free for all sellers", "Report priority", "Trusted seller label", "Profile highlight"] },
  { id: 2, name: "Pro Verified", price: 80, currency: "KES", trialDays: 3, color: "hsl(142 71% 45%)", badgeIcon: "ShieldPlus", benefits: ["Green checkmark", "Pro verified badge", "Trust score boost +25", "Top search placement", "Verified + Pro labels", "Advanced fraud protection", "ID verification", "Priority dispute resolution", "Featured seller section", "Quarterly review"] },
  { id: 3, name: "Business Verified", price: 150, currency: "KES", trialDays: 3, color: "hsl(45 93% 47%)", badgeIcon: "Award", benefits: ["Gold checkmark", "Business badge", "Trust score boost +50", "Business profile page", "Bulk listing tools", "Dedicated support", "Business analytics", "Tax invoice support", "Multi-user access", "Annual verification"] },
  { id: 4, name: "Premium Verified", price: 300, currency: "KES", trialDays: 3, color: "hsl(24 95% 53%)", badgeIcon: "Crown", benefits: ["Orange diamond badge", "Premium verified status", "Trust score boost +75", "VIP placement", "Unlimited listings", "Personal account manager", "Premium analytics", "API access", "White-label options", "Lifetime verification"] },
  { id: 5, name: "Enterprise Verified", price: 500, currency: "KES", trialDays: 3, color: "hsl(280 80% 55%)", badgeIcon: "Gem", benefits: ["Purple crown badge", "Enterprise status", "Trust score boost +100", "Exclusive placement", "Unlimited everything", "24/7 dedicated support", "Enterprise analytics", "Custom branding", "SLA guarantee", "Board-level verification"] },
];

// Categories that typically involve high-value transactions and require seller verification
export const HIGH_VALUE_CATEGORIES = ["Vehicles", "Real Estate", "Jobs", "Services"];
export const HIGH_VALUE_THRESHOLD = 100000; // KES — prompt verification above this
